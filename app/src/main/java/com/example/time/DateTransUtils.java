...
public class DateTransUtils {                       //时间戳转化为时间的
    ...
    public static long getTodayStartStamp(int hour,int minute,int second){
        ...
        Log.i("getTodayStartStamp"," DateTransUtils-getTodayStartStamp()  获取当日" + hour+ ":" + minute+ ":" + second+ "的时间戳 :" + todayStamp);
    ...
    public static long getZeroClockTimestamp(long time){
        ...
        Log.i("获取当天时间","获取当日00:00:00的时间戳,东八区则为早上八点 :" + currentStamp);
        return currentStamp;
    }
